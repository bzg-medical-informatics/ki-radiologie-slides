...
\begin{frame}[plain]{Was ist ein lernendes System?}
    \begin{figure}[hp]
    \centering
    \captionsetup{font=footnotesize}
    
    \includegraphics[scale=.60]{2-content/images/evas.png}  
    
    \caption{\href{https://inf-schule.de/content/kids/3_computerinalltag/5_lernende-systeme/1_schritt1/evas.png}{Lernendes System: Eva}}
    \end{figure}
\end{frame}
...
\begin{frame}[plain]
    ...
    \includegraphics[scale=.5]{2-content/images/ml_fields.png}
    
    \caption{\href{https://databasecamp.de/ki/unsupervised-learning}{Unsupervised Learning}}
    \end{figure}
\end{frame}
