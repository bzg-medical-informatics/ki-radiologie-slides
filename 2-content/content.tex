...
\begin{frame}[plain]
    ...
    \includegraphics[scale=.3]{2-content/images/KI_History.png}
...
\begin{frame}[plain]
    ...
    \includegraphics[scale=.27]{2-content/images/crm-turing_test.jpg}
...
\begin{frame}[plain]
    ...
    \includegraphics[scale=.28]{2-content/images/moores_law.png}
...
\begin{frame}[plain]
    ...
    \includegraphics[scale=.072]{2-content/images/data_generation.jpg}
...
\begin{frame}[shrink=5]{Unsupervised Learning}
    \begin{columns}[T]
        \begin{column}{0.47\textwidth}
            \begin{bee}[Kurz erklärt]
                Die KI bekommt viele Bilder, aber keine fertigen Antworten. Sie sucht selbst nach Gruppen und auffälligen Mustern.
                \begin{enumerate}[$\bullet$]
                    \item Beispiel: ähnliche Röntgenbilder zusammenordnen
                    \item Die Gruppen entstehen aus den Bildmerkmalen
                    \item Gut für Entdeckungen, aber die Gruppen müssen von Menschen gedeutet werden
                \end{enumerate}
            \end{bee}
        \end{column}
        \begin{column}{0.47\textwidth}
            \centering
            \includegraphics[width=\linewidth]{2-content/images/unsupervised-radiology.png}
            \par\centering{\scriptsize Röntgenbilder: \cite{wikimedia-normal-chest,wikimedia-bronchiolitis}.\\
            \url{https://commons.wikimedia.org/wiki/File:Normal_posteroanterior_(PA)_chest_radiograph_(X-ray).jpg}}\par
        \end{column}
    \end{columns}
\end{frame}

\begin{frame}[shrink=5]{Supervised Learning}
    \begin{columns}[T]
        \begin{column}{0.47\textwidth}
            \begin{bee}[Kurz erklärt]
                Die KI lernt mit vielen Beispielen, bei denen die richtige Antwort schon bekannt ist.
                \begin{enumerate}[$\bullet$]
                    \item Beispiel: Bild + Befund ``Tumor'' oder ``kein Tumor''
                    \item Die KI vergleicht ihre Vorhersage mit der Lösung
                    \item Danach kann sie neue Bilder einschätzen
                \end{enumerate}
            \end{bee}
        \end{column}
        \begin{column}{0.47\textwidth}
            \centering
            \includegraphics[width=\linewidth]{2-content/images/supervised-radiology.png}
            \par\centering{\scriptsize Röntgenbilder: \cite{wikimedia-normal-chest,wikimedia-bronchiolitis}.\\
            \url{https://commons.wikimedia.org/wiki/File:Bronchiolitis_chest_X-ray.jpg}}\par
        \end{column}
    \end{columns}
\end{frame}

\begin{frame}[shrink=5]{Semi-Supervised Learning}
    \begin{columns}[T]
        \begin{column}{0.47\textwidth}
            \begin{bee}[Kurz erklärt]
                Ein kleiner Teil der Bilder ist beschriftet. Die vielen unbeschrifteten Bilder helfen der KI trotzdem beim Lernen.
                \begin{enumerate}[$\bullet$]
                    \item Wenige Bilder: Befund ist durch Fachpersonen geprüft
                    \item Viele Bilder: noch kein Befund vorhanden
                    \item Praktisch, wenn Beschriften viel Zeit kostet
                \end{enumerate}
            \end{bee}
        \end{column}
        \begin{column}{0.47\textwidth}
            \centering
            \includegraphics[width=\linewidth]{2-content/images/semi-supervised-radiology.png}
            \par\centering{\scriptsize Röntgenbilder: \cite{wikimedia-normal-chest,wikimedia-bronchiolitis}.\\
            \url{https://commons.wikimedia.org/wiki/File:Normal_posteroanterior_(PA)_chest_radiograph_(X-ray).jpg}}\par
        \end{column}
    \end{columns}
...
\begin{frame}[shrink=5]{Reinforcement Learning}
    \begin{columns}[T]
        \begin{column}{0.47\textwidth}
            \begin{bee}[Kurz erklärt]
                Die KI probiert Handlungen aus und erhält Rückmeldung. Gute Entscheidungen werden verstärkt, schlechte korrigiert.
                \begin{enumerate}[$\bullet$]
                    \item Beispiel: Untersuchungsablauf möglichst sinnvoll planen
                    \item Belohnung: schneller und trotzdem sicher
                    \item Die KI lernt durch viele Versuche
                \end{enumerate}
            \end{bee}
        \end{column}
        \begin{column}{0.47\textwidth}
            \centering
            \includegraphics[width=\linewidth]{2-content/images/reinforcement-radiology.png}
            \par\centering{\scriptsize Röntgenbilder: \cite{wikimedia-normal-chest,wikimedia-bronchiolitis}.\\
            \url{https://commons.wikimedia.org/wiki/File:Bronchiolitis_chest_X-ray.jpg}}\par
        \end{column}
    \end{columns}
...
\begin{frame}[plain]{k-Means Clustering}
    ...
    \includegraphics[scale=.35]{2-content/images/Screenshot from 2024-06-10 23-13-00.png}
...
\begin{frame}[plain]{Clustering - DBSCAN vs k-Means}
    ...
    \includegraphics[scale=.5]{2-content/images/3eee0b_79f8969aef9e47edb2f6169e57c0dc55~mv2.png}
...
\begin{frame}[plain]{Supervised Learning}
    ...
    \includegraphics[scale=.3]{2-content/images/regression-vs.-classification.png}
...
\begin{frame}[plain]{Lineare Regression}
    ...
    \includegraphics[scale=.6]{2-content/images/Lineare_Regression.png}
...
\begin{frame}[plain]{Lineare Regression - Beispiel}
    ...
    \includegraphics[scale=.23]{2-content/images/Lin_reg_example.png}
...
\begin{frame}[plain]{Lineare Regression - Gleichung}
    ...
    \includegraphics[scale=.5]{2-content/images/Lin_reg_formula.png}
...
\begin{frame}[plain]{Logistische Regression - Beispiel}
    ...
    \includegraphics[scale=.9]{2-content/images/logistische-regression-beispiel.png}
...
\begin{frame}[plain]{Logistische Regression - Beispiel II}
    ...
    \includegraphics[scale=.8]{2-content/images/Logistische-Funktion.png}
